    ...
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        ...
        <p className="mt-3 max-w-3xl text-slate-600 leading-relaxed">
          We offer a range of personalized packages: from a one-time seat in our monthly group information session to
          full-service support including individual appraisals, claims plans, organized deliverables, and mock C&amp;P
          exam preparation. Each package is structured to give veterans clarity, confidence, and actionable guidance.
        </p>
